                ...
                {notes.map((note) => (
                    <div key={note.id} className="note-item">
                        <div className="notes-header">
                            ...
                            <button onClick={() => deleteNoteHandler(note.id)} data-testid={`delete-button-${note.id}`}></button>

                            {/* <button onClick={() => updateNoteHandler(note)}>Edit</button> */}
                            <button onClick={() => updateNoteHandler(note)} data-testid={`edit-button-${note.id}`}> Edit</button>
